...
# network
cnet = Sequential(
    ('line0', Linear( [784],       200, 'xavier_normal')),
    ('sigm0', nn.Sigmoid()),
    ('line1', Linear( [200],      200, 'xavier_normal')),
    ('sigm1', nn.Sigmoid()),
    ('line2', Linear( [200],        10, 'xavier_normal'))
)
...
with Logger(logdir='.', log_batch_interval=5000) as lg:
    ...
    # train
    trn.fit((x0,y0,16), epochs=5, validation_set=(x2,y2), eval_interval=5)
