...
from ummon.datasets.anomalyimagepatches import AnomalyImagePatches

class DisparityImagePatches(AnomalyImagePatches):
     """
     ...
     """
     def __init__(self, file, mode='rgb', mean_normalization=False, train = True, train_percentage=.8, transform=transforms.Compose([transforms.ToTensor()]),
